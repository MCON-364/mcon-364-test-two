...
public class InventoryManager {
    ...
    public boolean removeStock(String item, int qty) {
        ...
        // Atomically check-and-decrement inside a single compute() call.
        // The boolean flag is set to true only when the removal actually happens,
        // avoiding both the stale-read race condition and the Integer == reference bug.
